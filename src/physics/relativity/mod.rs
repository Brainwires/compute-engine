...
pub fn lorentz_transform(request: LorentzTransformRequest) -> Result<LorentzTransformResult, String> {
...
pub fn length_contraction(request: LengthContractionRequest) -> Result<LengthContractionResult, String> {
    let gamma = lorentz_factor(request.velocity)?;
...
pub fn relativistic_energy(request: RelativisticEnergyRequest) -> Result<RelativisticEnergyResult, String> {
    let gamma = lorentz_factor(request.velocity)?;
...
pub fn velocity_addition(request: VelocityAdditionRequest) -> Result<VelocityAdditionResult, String> {
...
pub fn gravitational_time_dilation(request: GravitationalTimeDilationRequest) -> Result<GravitationalTimeDilationResult, String> {
...
pub fn orbital_precession(request: OrbitalPrecessionRequest) -> Result<OrbitalPrecessionResult, String> {
...
pub fn gravitational_lensing(request: GravitationalLensingRequest) -> Result<GravitationalLensingResult, String> {
