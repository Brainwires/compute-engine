...
//! - Solve tool integration for optimization problems

// Solver integration for the Solve tool
mod solver;
pub use solver::solve_optimization;
...
// Test module
#[cfg(test)]
#[path = "../../../tests/unit/solve/optimization_tests.rs"]
mod tests;
