//! Unified Machine Learning implementation
//!
//! Routes ML requests to clustering, neural network, regression, and
//! dimensionality reduction modules in specialized/machine_learning/
...
impl UnifiedML {
    ...
    fn handle_clustering(&self, method: &ClusteringMethod, input: &MLInput) -> ToolResult<MLOutput> {
        use crate::specialized::machine_learning::clustering;
        ...
        match method {
            ...
            ClusteringMethod::DBSCAN => {
                // DBSCAN not yet implemented in the domain module
    ...
    fn handle_neural_network(&self, op: &NeuralNetworkOp, input: &MLInput) -> ToolResult<MLOutput> {
        use crate::specialized::machine_learning::neural_network;
        use crate::specialized::machine_learning::{ActivationFunction, LossFunction, TrainingConfig, OptimizerType};
        ...
        match op {
            ...
            NeuralNetworkOp::Train => {
                ...
                // Each tuple is (size, activation) - activation is for the OUTPUT of that layer
                ...
                use crate::specialized::machine_learning::optimization::train_network;
    ...
    fn handle_regression(&self, method: &RegressionMethod, input: &MLInput) -> ToolResult<MLOutput> {
        use crate::specialized::machine_learning::regression;
    ...
    fn handle_dim_reduction(&self, method: &DimReductionMethod, input: &MLInput) -> ToolResult<MLOutput> {
        use crate::specialized::machine_learning::dimensionality_reduction;
        ...
        match method {
            DimReductionMethod::PCA => {
                ...
                let result = dimensionality_reduction::pca(&data, n_components)
            ...
            DimReductionMethod::Transform => {
                ...
                let pca_result = dimensionality_reduction::PCAResult {
                    components,
                ...
                let transformed = dimensionality_reduction::transform(&data, &pca_result)
