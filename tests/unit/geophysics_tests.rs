use super::{calculate_geophysics, GeophysicsCategory, GeophysicsInput, GeophysicsParams};
...
fn test_atmosphere_temperature_celsius_conversion() {
    let input_celsius = GeophysicsInput {
        category: GeophysicsCategory::Atmosphere,
        parameters: GeophysicsParams {
            pressure: Some(101325.0),
    ...
    let input_kelvin = GeophysicsInput {
        category: GeophysicsCategory::Atmosphere,
        parameters: GeophysicsParams {
            pressure: Some(101325.0),
    ...
    let result_c = calculate_geophysics(input_celsius).unwrap();
    let result_k = calculate_geophysics(input_kelvin).unwrap();
